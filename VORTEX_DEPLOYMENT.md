...
```text
artifacts/simoore-homebridge-dreo-enhanced-5.1.4-vortex.7.tgz
```
...
```json
"@simoore/homebridge-dreo-enhanced": "file:packages/simoore-homebridge-dreo-enhanced-5.1.4-vortex.7.tgz"
```
